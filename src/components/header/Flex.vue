<template>
  <div class="flex">
    ...
    <div class="row cent">
      ...
      <div class="col-lg-6">
        <div class="skill">
          <img alt="Floating icons" src="/assets/img/header/floating-icons.svg">
        </div>
      </div>
    </div>
  </div>
